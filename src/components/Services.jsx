    ...
    return (
      <div className='px-4 md:px-8 lg:px-16'>
          <div className="container mx-auto py-8">
            <h1 className="text-3xl font-bold text-gray-800 mt-4 mb-8">Built for all kinds of teams</h1>
    ...
    <div className="w-full md:w-2/5 mb-8 md:mb-0 md:mr-8">
        ...
        <div className="flex flex-col gap-4">
            ...
            {activeItem.descriptiontwo && (
                <div className="flex gap-4">
                    <FaCheck className="text-center mt-1" />
                    <p className="text-gray-600 mb-4">{activeItem.descriptiontwo}</p>
                </div>
            )}
            {activeItem.descriptionthree && (
                <div className="flex gap-4">
                    <FaCheck className="text-center mt-1" />
                    <p className="text-gray-600 mb-4">{activeItem.descriptionthree}</p>
                </div>
            )}
            <Link
                to={activeItem.link}
