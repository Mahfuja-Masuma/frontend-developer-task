...
const MiroBanner = () => {
  return (
    <div className="container mx-auto py-8 md:py-12 lg:py-14 flex flex-col-reverse lg:flex-row justify-between items-center">
      <div className="text-center lg:text-left">
        ...
        <a
          to="#"
          className="block text-primary font-semibold mt-4 lg:mt-6 lg:text-left hover:text-primary-dark"
        >
          <span className="underline">Learn more</span>{" "}
          <span className="transition-all ml-1">&#8594;</span>
        </a>
      </div>
